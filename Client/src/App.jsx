    ...
    <div className="app">
      <header className="hero">
        <div className="hero-inner">
          ...
          <p className="tagline">
            A straight read on what the job market is hiring for.
          </p>
        </div>
      </header>
      ...
      <footer className="footer">
        Counts come from live job postings on Adzuna over the last 12 months. It's a snapshot of current demand, not a prediction.
      </footer>
    </div>
  )
}