  ...
  return (
    <div style={outerStyle} className={`group w-full h-full relative ${className}`}>
      <motion.div
        ...
        style={cardStyle}
        className="w-full h-full relative rounded-2xl bg-gradient-to-b from-[#121216] to-[#1A1A20] border border-[#26262E] overflow-hidden transition-shadow duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.6),_0_0_40px_rgba(235,0,41,0.05)]"
      >
